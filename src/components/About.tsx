const About = () => (
  <section
    ...
    data-dark
  >
    <div className="absolute -top-4 right-0 w-1/2 h-4 flex">
      <div className="h-full" style={{ width: "60%", background: "#FFD84D" }} />
      <div className="h-full" style={{ width: "40%", background: "#6C3DCE" }} />
    </div>
    <div className="relative z-10 flex flex-col md:flex-row gap-10 md:gap-16 justify-between items-stretch">
